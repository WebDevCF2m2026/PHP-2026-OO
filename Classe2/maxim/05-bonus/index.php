...
// création d'une instance de Chanson sans nomination
$morceau = new Chanson('Thriller','Michael Jackson',202);
// création d'une instance de Chanson avec nomination
...
echo "<br> Affichage des variables privée via des fonctions stocké public <br>";
echo "----------------------------------------------------------------------------<br>";
// Morceau 1
echo "{$morceau->getTitre()} — {$morceau->getArtiste()} ({$morceau->getDuree()} secondes) <br>";
// Morceau 2
echo $morceau2->getTitre() . $morceau2->getArtiste().' ('.$morceau2->getDuree();
