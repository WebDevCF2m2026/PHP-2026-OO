...
echo Chanson ::GENRE."<br>";

// création d'une instance de classe
$morceau = new Chanson('Thriller','Michael Jackson',202);

echo "{$morceau->getTitre()} - {$morceau->getArtiste()} {$morceau->getDuree()}
?>

<p>On utilise Chanson qu'on va faire ensemble dans 'Chanson.php'</p>
<h2>1. Créez une playlist avec :</h2>
<ul>
    ...
    <li>une méthode formaterDuree(int $secondes): string qui transforme un nombre de secondes en "mm:ss".<br> 
    <i>Indice : intdiv($secondes, 60) donne les minutes, $secondes % 60 les secondes ; complétez à deux chiffres avec str_pad((string) $s, 2, '0', STR_PAD_LEFT) ou sprintf('%02d', $s).</i></li>
</ul>
